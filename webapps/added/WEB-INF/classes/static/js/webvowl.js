...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function ( graphContainerSelector ){
	  ...
	  graph.paused = function ( p ){
		...
		setTimeout(function(){ 		console.log("highlight");		graph.highLightNodes(["81"]);	}, 2002);
		setTimeout(function(){ 		console.log("highlight");		graph.highLightNodes(["497"]);	}, 2002);
