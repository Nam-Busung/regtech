...
<Ontology xmlns="http://www.w3.org/2002/07/owl#"
    ...
    <Declaration>
        <ObjectProperty IRI="#전자금융감독규정_제63조1항6호"/>
    </Declaration>
    <Declaration>
    ...
    <DataPropertyAssertion>
        <DataProperty IRI="#내용"/>
        <NamedIndividual IRI="#전자금융감독규정_제63조1항1호"/>
        <Literal>법 제30조 및 시행령 제17조에 따른 허가나 등록요건상 최소자본금·출자총액
또는 기본재산 기준을 항상 충족할 것</Literal>
    </DataPropertyAssertion>
    <DataPropertyAssertion>
        <DataProperty IRI="#Rule"/>
        <NamedIndividual IRI="#전자금융감독규정_제63조1항2호"/>
...
ELSE IF ((금융위원회허가의무 = TRUE) AND (금융위원회등록의무 = TRUE) AND (대통령령으로정하는금액_30_2 + 대통령령으로정하는금액_30_3_1 + 대통령령으로정하는금액_30_3_2 &gt;= 5000000000)) THEN (최소요구자본금 = 5000000000)</Literal>
    ...
    <DataPropertyAssertion>
        <DataProperty IRI="#Rule"/>
        <NamedIndividual IRI="#전자금융거래법_제28조2항"/>
        <Literal>@전자금융거래법_제28조2항@ @((신청업무==&quot;전자자금이체업무&quot;) || (신청업무==&quot;직불전자지급수단의발행및관리업무&quot;) || (신청업무==&quot;선불전자지급수단의발행및관리업무&quot;)|| (신청업무==&quot;전자지급결제대행업무&quot;)|| (신청업무==&quot;대통령령이정하는전자금융업무&quot;))@이라면 @금융위원회 등록 의무@가@TRUE@ 이다.</Literal>
    </DataPropertyAssertion>
    <DataPropertyAssertion>
        <DataProperty IRI="#내용"/>
        <NamedIndividual IRI="#전자금융거래법_제28조2항"/>
...
5. 그 밖에 대통령령이 정하는 전자금융업무</Literal>
    ...
    <DataPropertyAssertion>
        <DataProperty IRI="#Rule"/>
        <NamedIndividual IRI="#전자금융거래법_제28조3항"/>
        <Literal>@전자금융거래법_제28조3항@제2항의 규정에 불구하고@((가맹점위치==&quot;대통령령기준범위&quot;) ||(총발행잔액&lt;=대통령령기준금액) ||(가입범위==&quot;대통령령기준가입범위&quot;)||(신청업무==&quot;대통령령이정하는전자지급결제대행에관한업무&quot;))@이라면@금융위원회 등록 의무@가@無@ 이다.</Literal>
    </DataPropertyAssertion>
    <DataPropertyAssertion>
        <DataProperty IRI="#내용"/>
        <NamedIndividual IRI="#전자금융거래법_제28조3항"/>
    ...
    <DataPropertyAssertion>
        <DataProperty IRI="#Rule"/>
        <NamedIndividual IRI="#전자금융거래법_제29조1항"/>
        <Literal>@전자금융거래법_제29조1항@ @(신청업무==&quot;전자채권의등록및관리업무&quot;)@이라면 @금융위원회 등록 의무@가@有@ 이다.</Literal>
    </DataPropertyAssertion>
    <DataPropertyAssertion>
        <DataProperty IRI="#내용"/>
        <NamedIndividual IRI="#전자금융거래법_제29조1항"/>
    ...
    <DataPropertyAssertion>
        <DataProperty IRI="#Rule"/>
        <NamedIndividual IRI="#전자금융거래법_제30조1항"/>
        <Literal>@전자금융거래법_제30조1항@제28조제1항의 규정에 따라 허가를 받고자 하는 자는 주식회사로서 @(자본금 &gt;= 5000000000) @이어야 @전자화폐발행및관리자격@이@有@ 이다.</Literal>
    </DataPropertyAssertion>
    <DataPropertyAssertion>
        <DataProperty IRI="#내용"/>
        <NamedIndividual IRI="#전자금융거래법_제30조1항"/>
...
5. 미상환잔액 대비 자기자본의 비율에 관한 사항(선불전자지급수단의 발행인 및 전자화폐발행자에 한한다)</Literal>
    ...
    <AnnotationAssertion>
        ...
        <Literal>@전자금융감독규정_제63조1항5호@전자금융업자가 @(((신청업무==&quot;전자화폐의발행및관리업무&quot;)&amp;&amp;(금융위원회허가여부==true))&amp;&amp;(유동성비율 &gt;= 0.6))||(((신청업무==&quot;선불전자지급수단의발행및관리업무&quot;)&amp;&amp;(금융위원회허가여부==true))&amp;&amp;(유동성비율 &gt;= 0.5))||(((신청업무!=&quot;전자화폐의발행및관리업무&quot;)||(신청업무!=&quot;선불전자지급수단의발행및관리업무&quot;))&amp;&amp;(유동성비율 &gt;= 0.35))@이라면@적격여부@가@TRUE@이다.</Literal>
    </AnnotationAssertion>
    <AnnotationAssertion>
        <AnnotationProperty abbreviatedIRI="rdfs:comment"/>
        <IRI>#전자금융감독규정_제63조1항6호</IRI>
        <Literal>@전자거래금융법시행령_제63조1항6호@ 전자금융업자가 항상 @(자기자본 &gt; 납입자본금)@ 이면 @적격여부@가 @TRUE@이다</Literal>
    </AnnotationAssertion>
    <AnnotationAssertion>
        <AnnotationProperty abbreviatedIRI="rdfs:comment"/>
...
@有@ 이다.</Literal>
    ...
    <AnnotationAssertion>
        ...
        <Literal>@전자금융거래법_제28조3항@제2항의 규정에 불구하고 @((가맹점위치 ==&quot;대통령령기준범위&quot;) || (총발행잔액&lt;=대통령령기준금액) || (가입범위==&quot;대통령령기준가입범위&quot;)|| (신청업무==&quot;대통령령이정하는전자지급결제대행에관한업무&quot;))@이라면 @금융위원회 등록 의무@가@無@ 이다.호</Literal>
    </AnnotationAssertion>
    <AnnotationAssertion>
        <AnnotationProperty abbreviatedIRI="rdfs:comment"/>
        <IRI>#전자금융거래법_제29조1항</IRI>
        <Literal>@전자금융거래법_제29조1항@ @(신청업무==&quot;전자채권의등록및관리업무&quot;)@이라면 @금융위원회 등록 의무@가@有@ 이다.호</Literal>
    </AnnotationAssertion>
    <AnnotationAssertion>
        <AnnotationProperty abbreviatedIRI="rdfs:comment"/>
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = function ( graph ){
	  ...
	  function displayPropertyInformation( property ){
		...
		setIriLabel(d3.select("#propComment"), property.commentForCurrentLanguage(), "http://"+window.location.host+"/owl_compare/#/"+property.commentForCurrentLanguage());
