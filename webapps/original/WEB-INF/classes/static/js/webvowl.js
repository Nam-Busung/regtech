	...
	module.exports = (function (){
	  ...
	  var Base = function ( graph ){
	    ...
	    this.raiseDoubleClickEdit = function ( forceIRISync ){
	      ...
	      if ( nodeElement === undefined || this.type() === "owl:Thing" || this.type() === "rdfs:문자" ) {
	    ...
	    this.animateDynamicLabelWidth = function ( dynamic ){
	      ...
	      if ( dynamic === true ) {
	        ...
	        shapeElement.transition().tween("attr", function (){
	          ...
	          .ease('linear')
	          .duration(100)
	          .attr({ x: -myWidth , y: -h , width: myWidth, height: h })
	          .each("end", function (){
	            that.updateTextElement();
	          });
	      } else {
	...
	module.exports = function ( graphContainerSelector ){
	  ...
	  graph.locateSearchResult = function (){
	    if ( pulseNodeIds && pulseNodeIds.length > 0 ) {
		  ...
		  console.log(pulseNodeIds[locationId]);
	      locationId++;
	  ...
	  graph.createDataTypeProperty = function ( node ){
	    ...
	    if ( defaultDatatypeName === "rdfs:문자" ) {
	      prototype = NodePrototypeMap.get("rdfs:문자");
	      aNode = new prototype(graph);
	      aNode.label("Literal");
...
/***/ (function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(d3) {module.exports = function (){
	  var options = {},
	    ...
	    supportedDatatypes = ["rdfs:문자", "xsd:boolean", "xsd:double", "xsd:integer", "xsd:string", "undefined"],
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var DATA_PROPERTY_DEFAULT_RANGE_TYPE = "rdfs:문자";
